...
static const char *rangercmd[] = { "st", "-title", "ranger", NULL };
static const char *dmenucmd[] = { "/home/antoine/dotfiles/dmenu/run-recent.sh", NULL };
static const char *logoutcmd[] = { "oblogout", NULL };

static Key keys[] = {
	/* modifier             key    function        argument */
	{ MODKEY,               32,    spawn,          {.v = logoutcmd } }, // o
	{ MODKEY,               40,    spawn,          {.v = dmenucmd } }, // d
	{ MODKEY|ShiftMask,     25,    spawn,          {.v = rangercmd } }, // Z
	{ MODKEY,               36,    spawn,          {.v = termcmd } }, // Return
	{ MODKEY,               53,    spawn,          {.v = firefoxcmd } }, // x
	...
	{ MODKEY|ShiftMask,     41,    setlayout,      {.v = &layouts[1]} }, // F                44  j       19  agrave
	{ MODKEY,               47,    setlayout,      {.v = &layouts[2]} }, // m                45  k       20  parenright
	...
	{ MODKEY,               19,    view,           {.ui = ~0 } },     // 0                   57  n 
	{ MODKEY|ShiftMask,     19,    tag,            {.ui = ~0 } },     // 0                   32  o 
	{ MODKEY,               59,    focusmon,       {.i = -1 } },      // comma               33  p 
	{ MODKEY,               60,    focusmon,       {.i = +1 } },      // period              38  q 
