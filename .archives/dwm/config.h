...
static const char *altbarcmd        = "sh $HOME/dotfiles/polybar/launch.sh"; /* Alternate bar launch command */
...
static const char col_cyan[]        = "#eca400";
...
static Key keys[] = {
	...
	{ MODKEY,               40,    spawn,          SHCMD("/home/antoine/.config/rofi/launchers/type-3/launcher.sh") }, // d
//	{ MODKEY,               40,    spawn,          SHCMD("/home/antoine/dotfiles/dmenu/run-recent.sh") }, // d
	...
	{ MODKEY|ShiftMask,     21,    setgaps,        {.i = +1 } },
	{ MODKEY,              110,    setgaps,        {.i = 0  } },
	...
	{ MODKEY|ShiftMask,     60,    tagmon,         {.i = +1 } },      // period     
        { 0,                   122,    spawn,          SHCMD("/usr/bin/pactl set-sink-volume @DEFAULT_SINK@ -5%") },
        { 0,                   121,    spawn,          SHCMD("/usr/bin/pactl set-sink-mute @DEFAULT_SINK@ toggle") },
        { 0,                   123,    spawn,          SHCMD("/usr/bin/pactl set-sink-volume @DEFAULT_SINK@ +5% ") },
        { 0,                   233,    spawn,          SHCMD("xbacklight -inc 10") },
        { 0,                   232,    spawn,          SHCMD("xbacklight -dec 10") },
	TAGKEYS(                10,                    0)                 // 1 
	TAGKEYS(                11,                    1)                 // 2                 
	TAGKEYS(                12,                    2)                 // 3                  
	TAGKEYS(                13,                    3)                 // 4                  
